  ...
  ngOnInit() {
    ...
    this.details = [
      ...
      },
      {
        ...
        location: 'Dębno',
        openAt: '2:42 AM',
        img: 'https://upload.wikimedia.org/wikipedia/commons/9/9d/Autumn_Colours_-_Stourhead_-_geograph.org.uk_-_1044997.jpg',
      },
      {
        id: 3,
        name: 'Cookley',
        location: 'Jiangduo',
        openAt: '5:46 AM',
        img: 'https://i.insider.com/5a61087d55ac562d008b4794?width=700',
      },
      {
        id: 4,
        name: 'Cardify',
        location: 'Mushie',
        openAt: '5:55 AM',
        img: 'https://i.insider.com/5ccb188f93a15212af7d5695?width=700',
      },
      {
        id: 5,
        name: 'Andalax',
        location: 'Dongling',
        openAt: '9:16 PM',
        img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTd2AW93JpVy6SIhp21z7FVz00PXrNZkU27OQ\u0026usqp=CAU',
      },
      {
        id: 6,
        name: 'Konklab',
        location: 'Ust-Maya',
        openAt: '5:24 PM',
        img: 'https://img.staticmb.com/mbcontent//images/uploads/2020/12/garden%20landscape%20design.jpg',
      },
      {
        id: 7,
        name: 'Sonair',
